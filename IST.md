...
- **ASA** - Analysis and Synthesis of Algorithms
    - [friaes/ASA](https://github.com/friaes/ist-asa)
- **OOP** - Object-Oriented Programming
    - [friaes/PO](https://github.com/friaes/ist-oop)
...
- **AI** - Artificial Intelligence
    - [friaes/AI](https://github.com/friaes/ist-ai)
- **DB** - Databases
    - [friaes/DB](https://github.com/friaes/ist-db)
...
- **Comp** - Compilers
    - [friaes/Comp](https://github.com/friaes/ist-comp)
...
- **DS** - Distributed Systems
    - [friaes/DS](https://github.com/friaes/ist-ds)
- **SEG** - Software Engineering
    - [friaes/SEG](https://github.com/friaes/ist-seg)
- **IP-CSE** - Integrated Project in Computer Science and Engineering
    - [friaes/IP-CSE](https://github.com/friaes/ist-integrated-project-cse)
